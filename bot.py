"""
Telegram Bot Constructor v4.0 - Complete Full Version
Supercell Donate Shops & Feedback Bots
Stack: aiogram 3.x, SQLAlchemy 2.0 (async), PostgreSQL
Bothost-compatible: reads BOT_TOKEN & DATABASE_URL from env
Payment APIs: Crypto Pay, YooMoney, RollyPay, Telegram Stars
Features: Promo codes, Balance system, Bot logs, Notifications,
         Auto-stop/start, Feedback reply via child bot,
         Broadcast to all users, Purchase notifications,
         Product management, Category management,
         Subscription system, Admin panel
...
logger.info("=" * 60)
logger.info("Bot Constructor v4.0 - Configuration Loaded")
logger.info(f"Channel: {CHANNEL_USERNAME}")
logger.info(f"Admin IDs: {ADMIN_IDS}")
logger.info(f"Stars Rate: 1 Star = {STARS_RATE} RUB")
logger.info("=" * 60)


# ═══════════════════════════════════════════════════════════
# EMOJI CLASS - Unicode Emojis for Cross-Platform Compatibility
# ═══════════════════════════════════════════════════════════

class Emoji:
    """
    Standard Unicode emojis that work everywhere without Premium.
    Using Unicode characters instead of custom emoji IDs for
    maximum compatibility across all Telegram clients.
    """
    ...
    LIST = "📋"              # List / Menu / Clipboard
    CHECK = "✅"             # Checkmark / Success / Done
    CROSS = "❌"             # Cross / Error / Cancel
    LOADING = "🔄"           # Loading / Processing / Sync
    WARNING = "⚠️"          # Warning / Caution / Alert
    INFO = "ℹ️"             # Information / Details
    QUESTION = "❓"          # Question / Help / Unknown
    PENCIL = "✏️"           # Edit / Pencil / Modify
    TRASH = "🗑️"           # Delete / Trash / Remove
    KEY = "🔑"               # Key / Token / Password
    LOCK = "🔒"              # Lock / Closed / Secured
    UNLOCK = "🔓"            # Unlock / Open / Active
    EYE = "👁️"             # Eye / View / Visible
    GEAR = "⚙️"             # Gear / Settings / Config
    TOOLS = "🛠️"           # Tools / Wrench / Build
    CHANNEL = "📢"           # Channel / Announcement
    SEND = "📤"              # Send / Upload / Forward
    ROCKET = "🚀"            # Rocket / Launch / Fast
    
    # ── Users and Profiles ──────────────────────────────────
    
    USERS = "👥"             # Users / People / Group
    PEOPLE = "👥"            # People / Community (alias)
    ROBOT = "🤖"             # Robot / Bot / AI
    BOT = "🤖"               # Bot (alias)
    CROWN = "👑"             # Crown / Premium / King
    STAR = "⭐"              # Star / Pro / Featured
    SMILE = "🙂"             # Smile / Happy
    ...
    SHOPPING_CART = "🛒"     # Shopping Cart / Buy
    SHOPPING_BAGS = "🛍️"   # Shopping Bags / Purchase
    SHOP = "🛒"              # Shop / Store (alias)
    
    # ── Payment Systems ─────────────────────────────────────
    
    CRYPTOBOT = "💎"         # Crypto Bot / Diamond
    TELEGRAM_STARS = "⭐"    # Telegram Stars
    BALANCE = "💳"           # Balance / Account
    
    # ── Communication ───────────────────────────────────────
    
    MEGAPHONE = "📣"         # Megaphone / Broadcast / Announce
    BELL = "🔔"              # Bell / Notification / Alert
    MAIL = "📧"              # Mail / Message / Email
    PHONE = "📱"             # Phone / Mobile / Contact
    FEEDBACK = "💬"          # Feedback / Chat / Message
    REPLY = "↩️"            # Reply / Answer / Respond
    FORWARD = "➡️"          # Forward / Send
    
    # ── Content and Items ───────────────────────────────────
    
    BOX = "📦"               # Box / Package / Product
    PACKAGE = "📦"           # Package (alias)
    GIFT = "🎁"              # Gift / Present / Bonus
    TAG = "🏷️"             # Tag / Label / Price
    DELIVERY = "📦"          # Delivery / Shipment (alias)
    ...
    CHART_UP = "📈"          # Chart Up / Growth
    CHART_DOWN = "📉"        # Chart Down / Decline
    BAR_CHART = "📊"         # Bar Chart (alias)
    
    # ── Celebration and Emotions ────────────────────────────
    
    PARTY = "🎉"             # Party / Celebration / Congrats
    TROPHY = "🏆"            # Trophy / Award / Winner
    SPARKLES = "✨"          # Sparkles / Magic / Special
    HEART = "❤️"            # Heart / Love / Like
    FIRE = "🔥"              # Fire / Hot / Popular
    
    # ── Gaming ──────────────────────────────────────────────
    
    LOLZ = "🎮"              # Gaming / Game / Video Game
    
    # ── Technology ──────────────────────────────────────────
    
    GLOBE = "🌍"             # Globe / World / Global
    LINK = "🔗"              # Link / URL / Connect
    LAPTOP = "💻"            # Laptop / Computer / PC
    MAGNIFYING_GLASS = "🔍"  # Search / Find / Lookup
    MICROSCOPE = "🔬"        # Microscope / Research
    TELESCOPE = "🔭"         # Telescope / Observe
    SATELLITE = "📡"         # Satellite / Connection
    SUBSCRIBE = "📱"         # Subscribe / Follow
    TEST = "🧪"              # Test / Experiment / Lab
    TEST_TUBE = "🧪"         # Test Tube (alias)
    
    # ── New Features (v4.0) ─────────────────────────────────
    
    PROMO = "🎫"             # Promo Code / Ticket / Coupon
    LOGS = "📋"              # Logs / History / Records
    NOTIFICATION = "🔔"     # Notification / Alert (alias)
    SALE = "💸"              # Sale / Discount / Deal
    DISCOUNT = "🏷️"        # Discount / Sale Tag
    PERCENT = "💯"           # Percent / 100 / Full
    STOP = "⏹️"            # Stop / Pause / Halt
    PLAY = "▶️"             # Play / Start / Begin
    PAUSE = "⏸️"           # Pause / Wait
    HISTORY = "📜"           # History / Log / Archive
    SEARCH = "🔍"            # Search / Find
    DATABASE = "🗄️"        # Database / Storage
    SECURITY = "🔐"         # Security / Protected
    VERIFIED = "✅"          # Verified / Confirmed (alias)
    BANNED = "🚫"            # Banned / Blocked / Forbidden
    THUMB_UP = "👍"          # Thumbs Up / Like / Approve
    THUMB_DOWN = "👎"        # Thumbs Down / Dislike
    CLAP = "👏"              # Clap / Applause
    PRAY = "🙏"              # Pray / Please / Thanks
    PIN = "📌"               # Pin / Marker / Save
    NEW = "🆕"               # New / Fresh
    HOT = "🔥"               # Hot / Trending (alias)
    COLD = "🧊"              # Cold / Ice
    FREE = "🆓"              # Free / No Cost
...
class User(Base):
    ...
    their subscription status, and balance.
    
    Fields:
        id: Primary key
        telegram_id: Unique Telegram user ID
        username: Telegram username (optional)
        balance: User's balance in RUB
        subscription_tier: Current subscription level (free/pro/premium)
        subscription_expires: When the subscription expires
        total_spent: Total amount spent across all purchases
    ...
    balance: Mapped[Decimal] = mapped_column(
        ...
        comment="User balance in RUB"
    )
    
    subscription_tier: Mapped[str] = mapped_column(
        String(20),
        default="free",
        comment="Subscription tier: free, pro, premium"
    )
...
class Subscription(Base):
    ...
    id: Mapped[int] = mapped_column(
        ...
        primary_key=True,
        autoincrement=True,
        comment="Unique subscription ID"
    )
...
class AdminConfig(Base):
    ...
    Fields:
        ...
        rollypay_terminal_id: RollyPay terminal ID
        rollypay_api_key: RollyPay API key
        rollypay_signing_secret: RollyPay signing secret
        pro_subscription_price: Price for PRO subscription
        premium_subscription_price: Price for PREMIUM subscription
    """
...
class ShopBot(Base):
    ...
    Fields:
        ...
        admin_id: Telegram ID of the bot admin
        crypto_bot_token: Bot-specific CryptoBot token
        yoomoney_wallet: Bot-specific YooMoney wallet
        rollypay_terminal_id: Bot-specific RollyPay terminal
        rollypay_api_key: Bot-specific RollyPay API key
        rollypay_signing_secret: Bot-specific RollyPay secret
        is_active: Whether the bot is active
        welcome_message: Custom welcome message
        support_username: Support contact username
        feedback_button_text: Text for feedback button
        feedback_button_reply: Reply text for feedback button
    ...
    id: Mapped[int] = mapped_column(
        ...
        primary_key=True,
        autoincrement=True,
        comment="Unique bot ID"
    )
    
    owner_id: Mapped[int] = mapped_column(
        BigInteger,
        nullable=False,
        comment="Bot owner Telegram ID"
    )
    ...
    bot_type: Mapped[str] = mapped_column(
        String(20),
        default="shop",
        comment="Bot type: shop or feedback"
    )
    
    admin_id: Mapped[int] = mapped_column(
        BigInteger,
        nullable=False,
        comment="Bot admin Telegram ID"
    )
    
    crypto_bot_token: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="CryptoBot token"
    )
    
    yoomoney_wallet: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="YooMoney wallet"
    )
    ...
    support_username: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="Support contact username"
    )
    ...
    feedback_button_reply: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Feedback button reply text"
    )
...
class Category(Base):
    ...
    Fields:
        id: Primary key
        bot_id: ID of the bot this category belongs to
        name: Category name
    ...
    bot_id: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment="Bot ID this category belongs to"
    )
...
class Product(Base):
    ...
    Fields:
        ...
        auto_deliver_text: Text to auto-deliver after purchase
    ...
    price: Mapped[Decimal] = mapped_column(
        Numeric(10, 2),
        nullable=False,
        comment="Product price in RUB"
    )
    
    is_available: Mapped[bool] = mapped_column(
        Boolean,
        default=True,
        comment="Whether product is available"
    )
    
    auto_deliver_text: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Auto-delivery text"
    )
    
    quantity: Mapped[int] = mapped_column(
        Integer,
        default=-1,
        comment="Available quantity (-1 = unlimited)"
    )
...
class Purchase(Base):
    ...
    Fields:
        id: Primary key
        user_id: Telegram ID of the buyer
        bot_id: ID of the bot where purchase was made
        product_id: ID of the purchased product
        amount: Purchase amount
        status: Purchase status (pending/completed)
        payment_method: Payment method used
        payment_id: External payment ID
        delivered_text: Text that was delivered to buyer
        promo_code: Promo code used (if any)
        discount_amount: Discount amount applied
        created_at: When the purchase was made
    """
    ...
    id: Mapped[int] = mapped_column(
        ...
        primary_key=True,
        autoincrement=True,
        comment="Unique purchase ID"
    )
    
    user_id: Mapped[int] = mapped_column(
        BigInteger,
        nullable=False,
        comment="Buyer Telegram ID"
    )
    ...
    delivered_text: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Delivered text"
    )
    
    promo_code: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="Promo code used"
    )
...
class FeedbackMessage(Base):
    ...
    Fields:
        ...
        user_id: Telegram ID of the user who sent feedback
        admin_id: Telegram ID of the admin
        message_text: The feedback message text
        reply_text: Admin's reply text
        is_replied: Whether the message has been replied to
...
class PromoCode(Base):
    """
    Promo code model for discounts and balance bonuses.
    
    Fields:
        id: Primary key
        code: Unique promo code (uppercase)
        bot_id: Bot ID (None = global, specific = bot-only)
        ...
        created_at: When the promo code was created
    """
    ...
    code: Mapped[str] = mapped_column(
        ...
        index=True,
        nullable=False,
        comment="Promo code (uppercase)"
    )
    
    bot_id: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Bot ID (None = global)"
    )
...
class BotLog(Base):
    """
    Log model for tracking bot actions.
    
    Fields:
        id: Primary key
        bot_id: ID of the bot
        user_id: Telegram ID of the user (optional)
...
class BotUser(Base):
    """
    Model for tracking all users who interacted with a bot.
    ...
    Fields:
        ...
        bot_id: ID of the bot
        user_id: Telegram ID of the user
        created_at: When the user first interacted
    """
...
async def run_migrations():
    ...
    Ensures backward compatibility when updating the bot.
    Checks each table and adds any columns that don't exist yet.
    """
    ...
    async with engine.begin() as conn:
        ...
        for col_name, col_type in product_column_definitions:
            if col_name not in products_columns:
                ...
                await conn.execute(
                    text(
                        f"ALTER TABLE products ADD COLUMN IF NOT EXISTS "
                        f"{col_name} {col_type}"
                    )
                )
        ...
        for col_name, col_type in purchase_column_definitions:
            if col_name not in purchases_columns:
                ...
                await conn.execute(
                    text(
                        f"ALTER TABLE purchases ADD COLUMN IF NOT EXISTS "
                        f"{col_name} {col_type}"
                    )
                )
...
async def add_log(
    ...
    """
    Add a log entry for a bot action.
...
async def register_bot_user(
    ...
    """
    Register a user as having interacted with a bot.
    ...
    if not exists:
        session.add(
            BotUser(bot_id=bot_id, user_id=user_id)
        )
        await session.commit()
...
async def apply_promo_code(
    ...
    Returns:
        Tuple of (new_amount, error_message)
        If error_message is None, the promo code was applied successfully.
    """
    result = await session.execute(
    ...
    if not promo:
        return amount, "Промокод не найден или неактивен."
    
    if promo.bot_id and promo.bot_id != bot_id:
        return amount, "Промокод недействителен для этого бота."
    
    if promo.max_uses > 0 and promo.current_uses >= promo.max_uses:
        return amount, "Промокод исчерпан."
    
    if promo.expires_at and promo.expires_at < datetime.utcnow():
        return amount, "Срок действия промокода истёк."
    ...
    if promo.discount_type == "percent":
        ...
        new_amount = max(Decimal("0.01"), amount - discount)
    else:
        return amount, "Неизвестный тип скидки."
...
class CryptoBotAPI:
    ...
    Attributes:
        BASE_URL: Base URL for Crypto Pay API
        token: API token from @CryptoBot
    """
...
class RollyPayAPI:
    ...
    Attributes:
        BASE_URL: Base URL for RollyPay API
...
def shop_menu_kb() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [
                KeyboardButton(
                    text=f"{Emoji.BALANCE} Баланс"
                ),
                KeyboardButton(
                    text=f"{Emoji.PROMO} Промокод"
                )
            ],
            [
                KeyboardButton(
...
def bot_management_kb(
    ...
    if bot_type == "shop":
        ...
        kb.inline_keyboard.extend([
            ...
            [
                InlineKeyboardButton(
                    text=f"{Emoji.PROMO} Промокоды",
                    callback_data=f"promo_codes:{bot_id}"
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=f"{Emoji.LOGS} Логи",
                    callback_data=f"bot_logs:{bot_id}"
                )
            ],
        ])
    else:
    ...
    # Common management options for all bot types
    toggle_text = (
...
def payment_method_sub_kb(tier: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=f"{Emoji.TELEGRAM_STARS} Telegram Stars",
                    callback_data=f"sub_pay:{tier}:stars"
                )
            ],
        ]
    )
...
def payment_method_kb(
    ...
    Only shows methods that are configured.
    ...
    # Telegram Stars and Balance are always available
    kb.inline_keyboard.append([
        InlineKeyboardButton(
            text=f"{Emoji.TELEGRAM_STARS} Telegram Stars",
...
def promo_management_kb(bot_id: int) -> InlineKeyboardMarkup:
    """
    Promo code management keyboard.
    
    Args:
        bot_id: ID of the bot
    
    Returns:
        InlineKeyboardMarkup with promo code management options
    """
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=f"{Emoji.ADD} Создать промокод",
                    callback_data=f"create_promo:{bot_id}"
                )
            ],
            [
                InlineKeyboardButton(
                    text=f"{Emoji.LIST} Список промокодов",
                    callback_data=f"list_promos:{bot_id}"
                )
            ],
            [
                InlineKeyboardButton(
                    text=f"{Emoji.TRASH} Удалить промокод",
                    callback_data=f"delete_promo_menu:{bot_id}"
                )
            ],
            [
                InlineKeyboardButton(
...
class CreatePromoFSM(StatesGroup):
    """States for creating a promo code"""
    bot_id = State()          # Bot ID
    code = State()            # Promo code
    discount_type = State()   # Discount type (percent/fixed)
    discount_value = State()  # Discount value
    max_uses = State()        # Maximum uses
    expires_days = State()    # Expiration in days


class PromoCodeInputFSM(StatesGroup):
    """States for promo code input in shop"""
    bot_id = State()          # Bot ID
    product_id = State()      # Product ID (optional)
    code = State()            # Entered promo code
...
async def cmd_start(message: Message):
    ...
    try:
        ...
        welcome_text = (
            ...
            f"• Принимайте платежи через CryptoBot, ЮMoney, "
            f"RollyPay, Telegram Stars\n"
            f"• Используйте промокоды и баланс\n"
            f"• Просматривайте логи и получайте уведомления\n\n"
    ...
    async with async_session_maker() as session:
        ...
        if method == "crypto":
            ...
            await callback.message.answer_invoice(
                title=f"Подписка {tier.upper()}",
                description=f"Подписка {tier.upper()} на 1 месяц",
                payload=f"sub_{sub.id}",
                provider_token="",
                currency="XTR",
                prices=[
                    LabeledPrice(
                        label=f"Подписка {tier.upper()}",
                        amount=stars_amount
                    )
                ],
                start_parameter=f"sub_{sub.id}"
            )
            sub.payment_id = f"stars_{sub.id}"
            await session.commit()
            return
...
@constructor_router.pre_checkout_query()
...
@constructor_router.message(F.successful_payment)
async def successful_payment(message: Message):
    ...
    if payload.startswith("sub_"):
        sub_id = int(payload.replace("sub_", ""))
        async with async_session_maker() as session:
            ...
            if sub:
                ...
                await message.answer(
                    ...
                    f"Тариф {names.get(sub.tier, sub.tier)} "
                    f"активирован!\n"
                    f"Действует до: "
        ...
        purchase_id = int(payload.replace("shop_", ""))
        async with async_session_maker() as session:
            ...
            if purchase and purchase.status != "completed":
                ...
                await add_log(
                    ...
                    f"{purchase.amount} Stars"
                )
                
                await message.answer(
                    f"{Emoji.CHECK} <b>Оплата Stars "
                    f"подтверждена!</b>\n\n"
                ...
                bot = await session.get(
                    ShopBot, purchase.bot_id
                )
                if bot:
                    try:
                        await message.bot.send_message(
                            bot.admin_id,
                            f"{Emoji.NOTIFICATION} "
                            f"<b>Новая покупка!</b>\n\n"
                            f"Бот: {bot.bot_name}\n"
                            f"Покупатель: "
...
@constructor_router.callback_query(F.data.startswith("promo_codes:"))
async def promo_codes_menu(callback: CallbackQuery):
    """
    ...
    await callback.message.edit_text(
        ...
        reply_markup=promo_management_kb(bot_id)
    )
    await callback.answer()


@constructor_router.callback_query(F.data.startswith("create_promo:"))
async def create_promo_start(
    ...
    await callback.message.answer(
        ...
        f"Введите код (латинские буквы и цифры):",
        reply_markup=cancel_kb()
    )
    await callback.answer()


@constructor_router.message(StateFilter(CreatePromoFSM.code))
async def create_promo_code(message: Message, state: FSMContext):
    ...
    await state.set_state(CreatePromoFSM.discount_type)
    
    await message.answer(
        f"{Emoji.TAG} Выберите тип скидки:",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="Фиксированная (руб)",
                    callback_data="promo_type:fixed"
                )
            ],
        ])
    )
...
@constructor_router.callback_query(
    StateFilter(CreatePromoFSM.discount_type),
    F.data.startswith("promo_type:")
)
async def create_promo_type(
    callback: CallbackQuery,
    state: FSMContext
):
    """
    ...
    await state.set_state(CreatePromoFSM.discount_value)
    
    label = (
        "процент скидки (например: 10)"
        if discount_type == "percent"
        else "сумму скидки в рублях (например: 50)"
    )
    
    await callback.message.answer(
        f"{Emoji.PENCIL} Введите {label}:",
        reply_markup=cancel_kb()
    )
    await callback.answer()


@constructor_router.message(StateFilter(CreatePromoFSM.discount_value))
async def create_promo_value(message: Message, state: FSMContext):
    ...
    await message.answer(
        f"{Emoji.USERS} Максимальное количество использований "
        f"(0 = без ограничений):"
    )


@constructor_router.message(StateFilter(CreatePromoFSM.max_uses))
async def create_promo_uses(message: Message, state: FSMContext):
    ...
    await state.set_state(CreatePromoFSM.expires_days)
    
    await message.answer(
        f"{Emoji.CALENDAR} Срок действия (дней, 0 = без ограничения):"
    )


@constructor_router.message(StateFilter(CreatePromoFSM.expires_days))
async def create_promo_finish(message: Message, state: FSMContext):
    """
    Finish creating promo code.
    """
    if message.text == f"{Emoji.CROSS} Отмена":
        await state.clear()
        return await message.answer(
    ...
    result_text = (
        f"{Emoji.CHECK} Промокод <b>{data['code']}</b> создан!\n"
        f"Тип: {data['discount_type']}\n"
        f"Значение: {data['discount_value']}\n"
        f"Использований: {data['max_uses'] or 'без ограничений'}\n"
        f"Срок: {f'{days} дн.' if days > 0 else 'без ограничения'}"
    )
...
@constructor_router.callback_query(F.data.startswith("list_promos:"))
async def list_promos(callback: CallbackQuery):
    """
    List all promo codes for a bot.
    """
    bot_id = int(callback.data.split(":")[1])
    ...
    async with async_session_maker() as session:
        promos = (await session.execute(
            select(PromoCode)
            .where(PromoCode.bot_id == bot_id)
            .order_by(PromoCode.created_at.desc())
        )).scalars().all()
    
    if not promos:
        return await callback.answer(
            "Нет промокодов.", show_alert=True
        )
    
    text = f"{Emoji.PROMO} <b>Промокоды бота</b>\n\n"
    ...
    for p in promos:
        ...
        text += (
            ...
            f"{p.discount_value}"
            f"{'%' if p.discount_type == 'percent' else 'руб'} | "
            f"{p.current_uses}/"
            f"{p.max_uses if p.max_uses > 0 else '∞'}\n"
        )
    
    await callback.message.edit_text(
        text, reply_markup=back_kb(bot_id)
    )
    await callback.answer()


@constructor_router.callback_query(
    F.data.startswith("delete_promo_menu:")
)
async def delete_promo_menu(callback: CallbackQuery):
    """
    Show promo code deletion menu.
    """
    bot_id = int(callback.data.split(":")[1])
    
    async with async_session_maker() as session:
        promos = (await session.execute(
            select(PromoCode).where(PromoCode.bot_id == bot_id)
        )).scalars().all()
    ...
    await callback.message.edit_text(
        f"{Emoji.TRASH} Выберите промокод для удаления:",
        reply_markup=inline_kb([
            (
                f"{p.code} ({p.discount_value}"
                f"{'%' if p.discount_type == 'percent' else 'руб'})",
                f"confirm_del_promo:{p.id}"
            )
            for p in promos
        ])
    )
...
@constructor_router.callback_query(
    F.data.startswith("confirm_del_promo:")
)
async def confirm_del_promo(callback: CallbackQuery):
    """
    ...
    await callback.message.edit_text(
        f"{Emoji.TRASH} Промокод «{code}» удалён.",
        reply_markup=back_kb(bot_id)
    )
    await callback.answer()
...
@constructor_router.callback_query(F.data.startswith("bot_logs:"))
async def bot_logs(callback: CallbackQuery):
    """
    Show bot action logs.
    """
    bot_id = int(callback.data.split(":")[1])
    ...
    if not logs:
        return await callback.answer(
            "Логи пусты.", show_alert=True
        )
    
    text = f"{Emoji.LOGS} <b>Логи «{bot.bot_name}»</b>\n\n"
...
async def bot_broadcast_start(
    ...
    await callback.message.answer(
        ...
        f"Сообщение получат ВСЕ пользователи этого бота.",
        reply_markup=cancel_kb()
    )
    await callback.answer()
    ...
    async with async_session_maker() as session:
        ...
        if bot and bot.owner_id == callback.from_user.id:
            ...
            await add_log(
                ...
                f"Bot {'activated' if bot.is_active else 'deactivated'}"
            )
...
def create_shop_router(bot_record: ShopBot) -> Router:
    ...
    async def shop_start(message: Message):
        ...
        async with async_session_maker() as session:
            ...
            await register_bot_user(
                session, bot_record.id, message.from_user.id
            )
            await add_log(
                session,
                bot_record.id,
    ...
    async def process_payment(
        ...
        Args:
            ...
            method: Payment method (crypto/yoo/rolly/stars/balance)
        """
        async with async_session_maker() as session:
            product = await session.get(Product, product_id)
            ...
            if method == "balance":
                ...
                user.total_spent = current_spent + product.price
                user.total_purchases = current_purchases + 1
                ...
                await callback.message.answer(
                    ...
                    f"{Emoji.MONEY} {product.price} руб\n"
                    f"💰 Остаток баланса: {user.balance} руб"
                )
                
                # Auto-delivery
                if product.auto_deliver_text:
                    try:
            ...
            # Create pending purchase for other payment methods
            purchase = Purchase(
                user_id=callback.from_user.id,
                bot_id=bot_record.id,
                product_id=product_id,
            ...
            if method == "crypto":
                ...
                stars_amount = int(product.price)
                
                await callback.message.answer_invoice(
                    title=product.name[:32],
                    description=f"Покупка: {product.name}"[:255],
                    payload=f"shop_{purchase.id}",
                    provider_token="",
                    currency="XTR",
                    prices=[
                        LabeledPrice(
                    ...
                    start_parameter=f"shop_{purchase.id}"
                )
                
                purchase.payment_id = f"stars_{purchase.id}"
                await session.commit()
                return
    ...
    @shop_router.callback_query(
        F.data.startswith("pay_stars:")
    )
    async def pay_stars(callback: CallbackQuery):
        """Handle Telegram Stars payment"""
        product_id = int(callback.data.split(":")[1])
        await process_payment(callback, product_id, "stars")
    ...
    async def pay_balance(callback: CallbackQuery):
        """Handle Balance payment"""
        product_id = int(callback.data.split(":")[1])
        await process_payment(callback, product_id, "balance")
    ...
    async def pre_checkout(pre_checkout_query: PreCheckoutQuery):
        """Handle pre-checkout for Telegram Stars"""
        await pre_checkout_query.answer(ok=True)
        ...
        async with async_session_maker() as session:
            ...
            if (
                ...
                await add_log(
                    ...
                    purchase.user_id,
                    f"Purchase #{purchase.id}: "
                    f"{purchase.amount}руб via {method}"
                )
    ...
    @shop_router.message(F.text == f"{Emoji.BALANCE} Баланс")
    async def shop_balance(message: Message):
        """Show user balance"""
        async with async_session_maker() as session:
            user = await get_or_create_user(
                session,
        ...
        await message.answer(
            f"{Emoji.BALANCE} <b>Ваш баланс:</b> {user.balance} руб\n\n"
            f"Пополнить можно через покупку Stars "
            f"или получение бонусов по промокодам."
        )
    
    
    # ── Promo Code Input ────────────────────────────────────
    
    @shop_router.message(F.text == f"{Emoji.PROMO} Промокод")
    async def shop_promo_input(
        message: Message,
        state: FSMContext
    ):
        """Ask user to enter promo code"""
        await state.set_state(PromoCodeInputFSM.code)
        await state.update_data(bot_id=bot_record.id, product_id=None)
        
        await message.answer(
            f"{Emoji.PROMO} Введите промокод:",
            reply_markup=cancel_kb()
        )
    
    
    @shop_router.message(StateFilter(PromoCodeInputFSM.code))
    async def shop_promo_apply(
        message: Message,
        state: FSMContext
    ):
        """Apply promo code and add bonus to balance"""
        if message.text == f"{Emoji.CROSS} Отмена":
            await state.clear()
            return await message.answer(
                "Отменено.", reply_markup=shop_menu_kb()
            )
        ...
        async with async_session_maker() as session:
            ...
            if (
                promo.bot_id
                and promo.bot_id != bot_record.id
            ):
                return await message.answer(
                    "❌ Промокод недействителен для этого бота."
                )
            ...
            await add_log(
                ...
                "promo_used",
                message.from_user.id,
                f"Promo {code}: +{bonus}руб to balance"
            )
        ...
        await message.answer(
            ...
            f"💰 На баланс начислено: <b>{bonus} руб</b>\n"
...
def create_feedback_router(bot_record: ShopBot) -> Router:
    ...
    via /reply_ID command in the child bot itself.
    """
    fb_router = Router()
    ...
    async def handle_feedback_message(message: Message):
        """
        Handle messages in feedback bot.
        - Admin can reply via /reply_ID text command
        - Regular messages are forwarded to admin
        ...
        # Handle admin reply command in child bot
        if message.text and message.text.startswith("/reply_"):
            try:
                # Parse command: /reply_123 Some reply text
                parts = message.text.split(" ", 1)
                msg_id = int(parts[0].replace("/reply_", ""))
                reply_text = parts[1] if len(parts) > 1 else ""
                
                if not reply_text:
                    return await message.answer(
                        "❌ Используйте формат:\n"
                        "<code>/reply_ID текст ответа</code>"
                    )
                
                async with async_session_maker() as session:
                    fb_msg = await session.get(
                        FeedbackMessage, msg_id
                    )
                    ...
                    # Verify admin rights
                    if fb_msg.admin_id != message.from_user.id:
                        return await message.answer(
                            "❌ У вас нет прав на ответ "
                            "на это сообщение."
                        )
                    
                    # Save reply
                    fb_msg.reply_text = reply_text
                    fb_msg.is_replied = True
                    await session.commit()
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                admin_text += (
                    ...
                    f"(ID: {bot_record.id})"
                    f"\n\nОтветить в этом боте: "
                    f"<code>/reply_{fb_msg.id} текст ответа</code>"
                )
...
async def run_shop_bot(bot_record: ShopBot):
    ...
    # Don't start inactive bots
    if not bot_record.is_active:
        logger.info(
            f"Bot '{bot_record.bot_name}' (id={bot_record.id}) "
            f"is inactive, skipping startup"
        )
        return
...
async def main():
    ...
    logger.info("=" * 60)
    logger.info("Starting Bot Constructor v4.0...")
    logger.info("=" * 60)
